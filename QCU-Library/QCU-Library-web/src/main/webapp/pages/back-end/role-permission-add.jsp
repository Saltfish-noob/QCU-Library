            ...
            <section class="content">
                ...
                <table id="dataList"
                    ...
                    <c:forEach items="${PermissionList}" var="permission">
                        ...
                        <c:forEach items="${otherPermission}" var="otherPermission" varStatus="o">
                            <c:choose>
                                <c:when test="${permission.id==otherPermission.id}">
                                    <c:if test="${flag}">
                                ...
                                <c:when test="${o.last&&permission.id!=otherPermission.id}">
                                    <c:if test="${flag}">
                                        <tr>
                                            <td>
                                                <input name="ids" type="checkbox"
                                                       value="${permission.id}" ${otherPermission.id!=permission.id?"checked":""}>
                                            </td>
                                            <td>${permission.id}</td>
                                            <td>${permission.permissionName }</td>
                                            <td>${permission.url}</td>
