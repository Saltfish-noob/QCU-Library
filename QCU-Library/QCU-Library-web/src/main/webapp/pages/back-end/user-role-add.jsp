            ...
            <section class="content">
                ...
                <table id="dataList"
                    ...
                    <c:forEach items="${roleList}" var="role">
                        ...
                        <c:forEach items="${otherList}" var="otherRole" varStatus="o">
                            <c:choose>
                                <c:when test="${otherRole.id==role.id}">
                                    <c:if test="${flag}">
                                ...
                                <c:when test="${o.last&&otherRole.id!=role.id}">
                                    <c:if test="${flag}">
                                    <tr>
                                        <td>
                                            <input name="ids" type="checkbox"
                                                   value="${role.id}" ${otherRole.id!=role.id?"checked":""}/>
                                        </td>
                                        <td>${role.id}</td>
                                        <td>${role.roleName }</td>
                                        <td>${role.roleDesc}</td>
