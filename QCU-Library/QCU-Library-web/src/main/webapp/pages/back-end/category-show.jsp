    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">类别表单</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/category/update.do"
              method="post">
            <!-- 正文区域 -->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input required type="text" class="form-control" name="categoryName"
                                   placeholder="类别名称" value="${category.categoryName}">
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
