                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                ...
                                <option ${pageInfo.pageSize==30?"selected":" "}>30</option>
                                <option ${pageInfo.pageSize==40?"selected":" "}>40</option>
                            ...
                            <c:choose>
                                <c:when test="${pageInfo.pages<=5}">
                                    <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a>
                                        </li>
                                    </c:forEach>
                                </c:when>
                                <c:otherwise>
                                    <c:if test="${pageInfo.pageNum+2>pageInfo.pages}">
                                        <c:forEach end="${pageInfo.pageNum-pageInfo.pages+2}" begin="1" step="1"
                                                   var="temp">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum-(5-temp)}&pageSize=${pageInfo.pageSize}">${pageInfo.pageNum-(5-temp)}</a>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                                    ...
                                    <c:if test="${pageInfo.pageNum-2<=0}">
                                        <c:forEach end="${3-pageInfo.pageNum}" begin="1" step="1"
                                                   var="temp">
                                            <li>
                                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${temp+pageInfo.pageNum+2}&pageSize=${pageInfo.pageSize}">${temp+pageInfo.pageNum+2}</a>
                                            </li>
                                        </c:forEach>
                                    </c:if>
                                </c:otherwise>
